...
```mermaid
flowchart LR
    A["Raw Human Telemetry<br>(SQLite Offline / PVT)"] --> B["Ingestion & Validation<br>(Pydantic Contracts)"]
    B --> C["Distributed Pipeline<br>(PySpark / dbt / PostgreSQL)"]
    C --> D["ML Walk-Forward<br>(scikit-learn / Zero-Bias)"]
    D --> E["Inference Serving<br>(FastAPI &lt;120ms / Docker)"]
